...
class SosAlertResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'constraint_type_label' => $this->constraint_type !== null ? $this->constraintTypeLabel : null,
            'constraint_reason' => $this->constraint_reason,
            'constrained_by' => $this->constrained_by,
            'constrained_by_user' => $this->whenLoaded('constrainedBy', fn () => [
                'id' => $this->constrainedBy->id,
                'name' => $this->constrainedBy->name,
            ]),
            'constrained_at' => $this->constrained_at?->toISOString(),
