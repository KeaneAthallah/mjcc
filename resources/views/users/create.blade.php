            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="responder_type"
                        ...
                        <option value="medical" @selected(old('responder_type') === 'medical')>Medis</option>
                        <option value="fire" @selected(old('responder_type') === 'fire')>Pemadam Kebakaran</option>
                        <option value="police" @selected(old('responder_type') === 'police')>Polisi</option>
                    </select>
                ...
                <div class="rounded-xl bg-emerald-50 border border-emerald-100 px-4 py-3 text-[12px] text-emerald-800">
                    <strong>Admin</strong> — akses penuh (data & pengguna) · <strong>Operator</strong> — kelola data operasional · <strong>Viewer</strong> — hanya membaca.<br>
                    <strong>Medis</strong> / <strong>Pemadam Kebakaran</strong> / <strong>Polisi</strong> — petugas yang menerima & menangani SOS sesuai kategorinya.
                </div>
            </div>
        </x-card>
