...
<x-source-widget-header icon="🛒" title="Pasar & Kebutuhan Pokok" subtitle="Pantauan harga komoditas dari Kementerian Perdagangan (SP2KP)" key="sp2kp" :asOf="$latestDate" accent="emerald">
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
    ...
    <x-stat-card label="Rata-rata Perubahan" :value="$averageChange !== null ? number_format($averageChange, 1, ',', '.') . '%' : '—'" icon="📊" color="red"/>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (prices.length > 0) {
        ...
        window.Mjcc.charts.makeBar(document.getElementById('chart-commodity'), labels, [{ data, label: 'Harga', backgroundColor: colors, borderWidth: 1 }]);
    }
});
</script>
@endpush